...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Symptom_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Symptom_t qt_meta_stringdata_Symptom = {
    {
QT_MOC_LITERAL(0, 0, 7), // "Symptom"
QT_MOC_LITERAL(1, 8, 23), // "on_symptomcheck_clicked"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "Symptom\0on_symptomcheck_clicked\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Symptom[] = {
...
void Symptom::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_symptomcheck_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject Symptom::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_Symptom.data,
